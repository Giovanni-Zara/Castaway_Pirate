...
export class GameLogic {
    ...
    async initializeGame(shadowsEnabled, progressCallback = null) {
        try {
            ...
            updateProgress(70, "Loading Captain Pirate...");
            // Create player
            this.playerObject = new Pirate(this.scene, { x: -140, y: 1, z: 0 }); //-60 1 0
            ...
            if (!this.playerObject.loaded) {
                console.error('pirate failed to initialize properly');
                return;
            }

            console.log('pirate loaded, waiting for mesh...');
            ...
            if (!this.playerObject.mesh) {
                console.error('pirate mesh failed to initialize properly');
                return;
            }
    ...
    gameLoop() {
        ...
        this.gameTime += 0.016; //each frame gets animation
